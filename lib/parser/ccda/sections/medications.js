...
*/
        ...
        var MedicationActivity = component.define("MedicationActivity")
            ...
            .cleanupStep(function(){
                if(this.js && Object.keys(this.js).length === 1 && this.js.source_section_code)
        ...
        */
        ...
        medicationsSection.templateRoot([
            "2.16.840.1.113883.10.20.22.2.1", //Medications (entries optional)
            "2.16.840.1.113883.10.20.22.2.1.1", //Medications (entries required)
            "2.16.840.1.113883.10.20.22.2.44", //Hospital Admission Medications Section 42346-7 (entries optional)
            "2.16.840.1.113883.10.20.22.2.11.1", //Hospital Discharge Medications (entries required)
            "2.16.840.1.113883.10.20.22.2.38", //Medications Administered Section 29549-3
        ...
        var MedicationStatusObservation = component.define("MedicationStatusObservation")
            .templateRoot(clinicalStatementsIDs.MedicationStatusObservation)
            .fields([
                ["status", "0..1", "h:value", shared.ConceptDescriptor]
            ]);
        ...
        var MedicationActivity = component.define("Medications")
            ...
            .fields([
                ...
                ["statusObservation", "1..1", MedicationStatusObservation.xpath(), MedicationStatusObservation],
                ["sig", "0..1", "h:text", shared.TextWithReference],
