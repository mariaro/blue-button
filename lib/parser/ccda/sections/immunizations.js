...
var exportImmunizationsSection = function (version) {
    ...
    var immunizationActivityProduct = component.define('immunizationActivityProduct')
        .fields([
            ...
            ["manufacturer", "0..1", "h:manufacturerOrganization", shared.Organization],
        ]);
    ...
    var ImmunizationActivity = component.define("ImmunizationActivity")
        ...
        .fields([
            ...
            ["instructions", "0..1", "h:entryRelationship[h:act/h:templateId/@root='2.16.840.1.113883.10.20.22.4.20']/h:act", ImmunizationInstructions],
            ["refusal_reason", "0..1", "h:entryRelationship[h:observation/h:templateId/@root='2.16.840.1.113883.10.20.22.4.53']/h:observation/h:code", shared.ConceptDescriptor],
        ]);
