...
var exportProblemsSection = function (version) {
    ...
    var ProblemConcernAct = component.define("ProblemConcernAct")
        ...
        .fields([
            ...
            ["onset_age", "0..1", "h:entryRelationship/h:observation/h:entryRelationship/h:observation/h:templateId[@root='2.16.840.1.113883.10.20.22.4.31']/../h:value/@value", Processor.asFloat],
