...
ConceptDescriptor.cleanupStep(Cleanup.cleanupConceptDescriptor);

var SectionCode = exports.SectionCode = ConceptDescriptor.define("SectionCode");
SectionCode.fields([
    ["title", "0..1", "../h:title"],
]);
SectionCode.cleanupStep(function() {
    if(!this.js)
        return;

    if(!this.js.name || this.js.name === '') {
        this.js.name = this.js.title;
    }

    delete this.js.title;
});
...
var assignedEntity = exports.assignedEntity = Component.define("assignedEntity")
    .fields([
        ...
        ["functionCode", "0..1", "../h:functionCode", ConceptDescriptor]
    ]);
